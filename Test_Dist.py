...
def test_model():
    ...
    # valset_dir = './Datasets/SHU_FABLFQA_5x64x64/'
    # dataset_name = 'SHU'
    ...
    for id, model_name in enumerate(test_scene_id_list):
        load_model_path = load_all_model_path + '/' + \
                          str(model_name[0]) + '_' + str(model_name[1]) + '/FABLFQA_epoch50.pth.tar'
    ...
    f = h5py.File('./Results/FABLFQA_result_' + dataset_name + '_' + dist + '.h5', 'w')
